...
public class MINNotificationGenerateAuthHashMutation: GraphQLMutation {
  public static let operationName: String = "MINNotificationGenerateAuthHash"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"mutation MINNotificationGenerateAuthHash($identifier: String!) { notificationGenerateAuthHash(identifier: $identifier) }"#
    ))
