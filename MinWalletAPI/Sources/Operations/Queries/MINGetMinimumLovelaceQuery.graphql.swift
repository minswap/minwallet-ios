...
public class MINGetMinimumLovelaceQuery: GraphQLQuery {
  public static let operationName: String = "MINGetMinimumLovelaceQuery"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query MINGetMinimumLovelaceQuery($address: String!) { getMinimumLovelace(address: $address) }"#
    ))
